...
@WebServlet(name="p1", urlPatterns={"/p1"})
...
"	\n" +
"<strong><<< Poni&#380;ej znajduje si&#281; lista nades&#322;anych zamówie&#324; >>></strong> \n" +
"</div>");      
          
   ResultSet rs9 = sql9.executeQuery("SELECT koszyk.data_realizacji from koszyk where koszyk.realizacja='1';");
...
"                <tr>\n" +
"                  <th>Lp.</th>\n" +
"                  <th>Data wys&#322;ania zam&#243;wienia</th>\n" +
...
"              <tbody>");
 ...
 ResultSet rs = sql.executeQuery("SELECT DISTINCT koszyk.data_realizacji,koszyk.id_user,koszyk.data2,user.imie,user.nazwisko from koszyk,user where koszyk.realizacja='1' and koszyk.id_user=user.id_user order by koszyk.data_realizacji desc;");
...
int nr_wiersza=1;
      ...
      while(rs.next())  {
           ...
           out.print("<tr class=\"row-a\"><td class=\"first\">"+ nr_wiersza + ".</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+" "+rs.getString(5)+"</td>");
         out.print("<td ><a href=\"p_1_2?id_u="+rs.getString(2)+"&id_user="+request.getParameter("id_user")+"&d="+rs.getString(1)+"\"><font color='blue'>realizuj</font></a></td></tr>");
        nr_wiersza++;
      }
