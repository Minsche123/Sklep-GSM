 ...
 * @author  
 */
@WebServlet(name="skasuj_realizacja", urlPatterns={"/skasuj_realizacja"})
public class skasuj_realizacja extends HttpServlet {
    ...
    throws ServletException, IOException {
       response.setContentType("text/html; CHARSET=windows-1250");
        ...
        String id_koszyk=request.getParameter("id_koszyk");
       ...
       String id_user= request.getParameter("id_user");
        ...
        try
        {
         ...
         sql.executeUpdate("delete from koszyk where id_koszyk='"+id_koszyk+"';");
