 ...
 * @author  
 */
@WebServlet(name="a_dodaj_producent", urlPatterns={"/a_dodaj_producent"})
public class a_dodaj_producent extends HttpServlet {
  ...
  String id_user=request.getParameter("id_user");
      ...
      sql=polaczenie.createStatement();
               ...
               sql.executeUpdate("insert into typ (typ) values('"+producent+"');");
                ...
                response.sendRedirect("a_dodaj2?id_user="+request.getParameter("id_user")+"&id_rodzaj="+request.getParameter("id_rodzaj")+"");
