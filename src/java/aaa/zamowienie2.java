 ...
 * @author  
 */
@WebServlet(name="zamowienie2", urlPatterns={"/zamowienie2"})
...
String data_rr= request.getParameter("data_rr");
...
"	\n" +
" <strong><<< Produkty z zamówienia: >>></strong> </div>");   
          
          
                  ResultSet rs9 = sql9.executeQuery("SELECT magazyn.nazwa, magazyn.cena from magazyn, koszyk where ((koszyk.realizacja='1') or (koszyk.realizacja='2')) and koszyk.id_user='"+id_user+"' and koszyk.data_realizacji='"+data_rr+"'  and koszyk.id_magazyn=magazyn.id_magazyn;");
...
"              <tbody>");
      ...
      ResultSet rs15 = sql15.executeQuery("Select magazyn.nazwa, magazyn.cena, magazyn.id_magazyn,koszyk.id_koszyk,koszyk.ilosc,magazyn.obraz,typ.typ from magazyn,koszyk,typ where ((koszyk.realizacja='1') or (koszyk.realizacja='2')) and koszyk.id_user='"+id_user+"' and koszyk.data_realizacji='"+data_rr+"' and koszyk.id_magazyn=magazyn.id_magazyn and magazyn.id_typ=typ.id_typ;");
int nr_wiersza=1;
float koniec=0;
      while(rs15.next())  {
...
koniec += sumka;
         ...
         out.println(" <tr>");
            out.println("<td></td><td</td><td></td><td></td><td ><strong>SUMA</strong></td>");
           out.println(" <td class=\"label label-important\" style=\"display:block\"> <strong>" + koniec);
