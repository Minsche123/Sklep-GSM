 ...
 * @author  
 */
@WebServlet(name="producent", urlPatterns={"/producent"})
public class producent extends HttpServlet {
...
"    \n" +
"      <a href=\"k_1_345?id_magazyn="+rs.getString(5)+"\" class=\"thumbnail product-thumbnail\">\n" +
...
"            <a href=\"k_1_345?id_magazyn="+rs.getString(5)+"\" class=\"btn btn-primary view-button\" title=\"View Detail\">                Zobacz więcej</a>\n" +
"           \n" +
"        </div>                                \n" +
"\n" +
"    </div>\n" +
...
"<a href=\"k_1_345?id_magazyn="+rs.getString(5)+"\" title=\"consectetur adipiscing\" title=\"consectetur adipiscing\">"+rs.getString(2)+"</a></h3>\n" +
