...
"	\n" +
"<strong><<< Poni&#380;ej znajduje si&#281; lista zam&#243;wie&#324; zrealizowanych lub b&#281;d&#261;cych w trakcie realizacji >>></strong> \n" +
"</div>");      
          
          
           ResultSet rs9 = sql9.executeQuery("SELECT koszyk.data_realizacji from koszyk where ((koszyk.realizacja='1') or (koszyk.realizacja='2')) and koszyk.id_user='"+id_user+"';");
...
"              <tbody>");
 ...
 ResultSet rs = sql.executeQuery("SELECT DISTINCT koszyk.data_realizacji,koszyk.realizacja,koszyk.data2 from koszyk where ((koszyk.realizacja='1') or (koszyk.realizacja='2')) and koszyk.id_user='"+id_user+"' order by koszyk.data_realizacji desc;");

int nr_wiersza=1;

      while(rs.next())  {

           out.print("<tr class=\"row-a\"><td class=\"first\">"+ nr_wiersza + ".</td><td>"+rs.getString(3)+"</td>");
      if  (rs.getString(2).compareTo("2")!=0)
      {
      out.print("<td ><i><b><font color='red'>w tarkcie realizacji</font></b></i>&nbsp;&nbsp;</td>");
      out.print("<td><a href=\"zamowienie2?id_user="+request.getParameter("id_user")+"&data_rr="+rs.getString(1)+"\"><font color='blue'>zobacz</font></a></td></tr>");
      ...
      {
       out.print("<td><i><b><font color='green'>zrealizowane</font></b></i>&nbsp;&nbsp;</td>");
      out.print("<td><a href=\"zamowienie2?id_user="+request.getParameter("id_user")+"&data="+request.getParameter("data")+"&data_rr="+rs.getString(1)+"\"><font color='blue'>zobacz</font></a></td></tr>");
