 ...
 * @author  
 */
@WebServlet(name="dodaj_kategoria", urlPatterns={"/dodaj_kategoria"})
public class dodaj_kategoria extends HttpServlet {
  ...
  String id_user=request.getParameter("id_user");
      ...
      sql=polaczenie.createStatement();
               sql.executeUpdate("insert into rodzaj (nazwa) values('"+kategoria+"');");
                response.sendRedirect("p_kategorie?id_user="+request.getParameter("id_user")+"");
                }
            catch (Exception e)
            {
