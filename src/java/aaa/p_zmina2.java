 ...
 * @author  
 */
@WebServlet(name="p_zmina2", urlPatterns={"/p_zmina2"})
public class p_zmina2 extends HttpServlet {
...
String haslo2=request.getParameter("haslo2");
      ...
      sql=polaczenie.createStatement();
               ...
               polaczenie.close();
    response.sendRedirect("w_zmina3?id_user="+request.getParameter("id_user")+"");
polaczenie.close();
                }
