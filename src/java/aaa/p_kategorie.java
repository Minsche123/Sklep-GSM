 ...
 * @author  
 */
@WebServlet(name="p_kategorie", urlPatterns={"/p_kategorie"})
public class p_kategorie extends HttpServlet {
...
"");
 ...
 out.write("function przetwarzajj_dane (){\n");
      ...
      out.write("    if (formularz.kategoria.value== \"\")\n");
      out.write("  {\n");
...
"<h1>Zarz&#261;dzaj nazwami kategorii produktów</h1>\n" +
"        </header>\n" +
"      \n" +
"    \n" +
"\n" +
...
"        \n" +
        ...
        "	<h3> Nazwy kategorii:</h3>	\n" +
"	<hr class=\"soft\"/>");

     
          
   ResultSet rs9 = sql9.executeQuery("SELECT id_rodzaj, nazwa from rodzaj order by nazwa;");
...
"              <tbody>");
 ...
 ResultSet rs = sql.executeQuery("SELECT id_rodzaj, nazwa from rodzaj order by nazwa;");
...
int nr_wiersza=1;
      ...
      while(rs.next())  {
           ...
           out.print("<tr ><td >"+ nr_wiersza + ".</td><td>"+rs.getString(2)+"</td>");
         out.print("</tr>");
        nr_wiersza++;
      }
...
out.write(" <br><h3> Dodaj kategori&#281;</h3><form  method=\"post\" action=\"dodaj_kategoria\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj nazw&#281; kategori</label>\n" +
"<div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"kategoria\" value=\"\"></div>\n" +
