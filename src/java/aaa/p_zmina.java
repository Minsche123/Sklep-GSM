 ...
 * @author  
 */
@WebServlet(name="p_zmina", urlPatterns={"/p_zmina"})
public class p_zmina extends HttpServlet {
...
"      \n" +
"\n" +
"  <form  method=\"post\" action=\"p_zmina2\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Nowe has&#322;o</label>\n" +
"<div class=\"col-md-6\"><input class=\"form-control\" name=\"haslo\" type=\"password\" value=\"\"></div>\n" +
"<div class=\"col-md-3 form-control-comment\"></div>\n" +
"</div>\n" +
"\n" +
"\n" +
" <div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Powtórz has&#322;o</label>\n" +
" <div class=\"col-md-6\">\n" +
"<div class=\"input-group js-parent-focus\">\n" +
"<input class=\"form-control\" type=\"password\"  name=\"haslo2\"></div>");
