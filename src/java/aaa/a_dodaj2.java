 ...
 * @author  
 */
@WebServlet(name="a_dodaj2", urlPatterns={"/a_dodaj2"})
public class a_dodaj2 extends HttpServlet {
...
"");
 ...
 out.write("function przetwarzajj_dane (){\n");
      ...
      out.write("    if (formularz.nazwa.value== \"Nazwa...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano nazwy towaru\\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
      
            out.write("    if (formularz.cena.value== \"Cena...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano ceny towaru\\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
...
"	<form class=\"form-horizontal\" method=\"post\" action=\"a_dodaj3\"   >\n" +
...
out.write(" <label class=\"col-md-3 form-control-label required\">Nazwa produktu</label><div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"nazwa\" value=\"\"></div>");
out.write(" <div class=\"col-md-3 form-control-comment\"></div>");
out.write(" </div>");

out.write(" <div class=\"form-group row \">");
out.write(" <label class=\"col-md-3 form-control-label required\">Cena produktu </label><div class=\"col-md-6\"><input class=\"form-control\" name=\"cena\" type='text' value=\"\"></div>");
out.write(" <div class=\"col-md-3 form-control-comment\"></div>");
out.write(" </div>");
       ...
       out.write(" 			<div class=\"form-group row \">\n" +
"			<label class=\"col-md-3 form-control-label required\">Wybierz producenta</label>\n" +
"			<div class=\"col-md-6\">\n" +
"			<select class=\"form-control\"  name='id_typ' >");
               
               
               
               
               
                 ResultSet rs11 = sql11.executeQuery("Select typ,id_typ from typ order by typ;");
                   while(rs11.next())

      {
           out.write("<option value='"+rs11.getString(2)+"'>"+rs11.getString(1)+"</option>\n");
      }
...
"		</div>");
     ...
     out.write(" <div class=\"form-group row \">");
out.write(" <label class=\"col-md-3 form-control-label required\">Scie&#380;ka do obrazka </label><div class=\"col-md-6\"><input class=\"form-control\" type=\"file\" name='obraz' value=\"\"></div>");
out.write(" <div class=\"col-md-3 form-control-comment\"></div>");
out.write(" </div>");          
...
"<input type='hidden' name='id_rodzaj' value='"+request.getParameter("id_rodzaj")+"'>\n" +
...
"<br><br> <h3>Brak producenta - Podaj nazw&#281; nowego</h3> <form  method=\"post\" action=\"a_dodaj_producent\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj nazw&#281; nowego producenta</label><div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"producent\" value=\"\"></div>\n" +
...
"</div>");
     ...
     out.print("<input  type='hidden' name='id_user' value='"+request.getParameter("id_user")+"'>");        
     out.print("<input type='hidden' name='id_rodzaj' value='"+request.getParameter("id_rodzaj")+"'>");    
 out.print("<br><button class=\"btn btn-primary\" data-link-action=\"sign-in\" type=\"submit\" class=\"form-control-submit\">Dalej</button>\n" +
"</div>\n" +
"</div>\n" +
"    </section></form>\n" +
"\n" +
