 ...
 * @author  
 */
@WebServlet(name="p_fakt_klien2", urlPatterns={"/p_fakt_klien2"})
public class p_fakt_klien2 extends HttpServlet {
...
"        </header>");
 ...
 ResultSet rs9 = sql9.executeQuery("Select DISTINCT user.imie,user.nazwisko,user.nazwisko,user.nazwisko,user.id_user,koszyk.data_realizacji from user,koszyk where user.dostep='1' and (user.nazwisko like '%"+fraza3+"%' ) and user.id_user=koszyk.id_user and koszyk.realizacja='2';");
...
"              <tbody>");
      ...
      ResultSet rs = sql.executeQuery("Select DISTINCT user.imie,user.nazwisko,user.nazwisko,user.nazwisko,user.id_user,koszyk.data_realizacji from user,koszyk where user.dostep='1' and (user.nazwisko like '%"+fraza3+"%' ) and user.id_user=koszyk.id_user and koszyk.realizacja='2' order by koszyk.data_realizacji desc;");
...
int nr_wiersza=1;
      ...
      while(rs.next())  {
           ...
           out.print("<tr class=\"row-a\"><td class=\"first\">"+ nr_wiersza + ".&nbsp;</td><td>"+rs.getString(1)+" "+rs.getString(2)+" </td><td>"+rs.getString(6)+" </td>");
            out.print("<td><a href=\"p_fakt_klien3?id_user="+request.getParameter("id_user")+"&id_u="+rs.getString(5)+"&data_realizacji="+rs.getString(6)+"\"><b><font color='blue'>zobacz</font></b></a></td></tr>");
