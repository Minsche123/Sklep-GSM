 ...
 * @author  
 */
@WebServlet(name="p_dane_klient", urlPatterns={"/p_dane_klient"})
public class p_dane_klient extends HttpServlet {
...
String fraza3= request.getParameter("fraza3");
...
"        </header>");
   ...
   ResultSet rs9 = sql9.executeQuery("SELECT imie,nazwisko,ulica,nr_u,miasto,kod,telefon,dostep,blokada,id_user from user order by nazwisko;");
...
"              <tbody>");
 ...
 ResultSet rs = sql.executeQuery("SELECT imie,nazwisko,ulica,nr_u,miasto,kod,telefon,dostep,blokada,id_user from user order by nazwisko;");
...
int nr_wiersza=1;
      ...
      while(rs.next())  {
           ...
           out.print("<tr class=\"row-a\"><td class=\"first\">"+ nr_wiersza + ".</td><td>"+rs.getString(2)+" "+rs.getString(1)+"</td><td>ul. "+rs.getString(3)+" "+rs.getString(4)+", "+rs.getString(6)+" "+rs.getString(5)+"</td><td>"+rs.getString(7)+"</td>");
         
           
      if  (rs.getString(8).compareTo("1")!=0)
      {
 out.println("<td><font color='red'>admin</td>");
      ...
      {
 out.println("<td><font color='green'>klient</td>");

      }      
           
           
      
            if  (rs.getString(9).compareTo("1")!=0)
      {
 out.println("<td><font color='red'>odblokowane</td>");
 out.print("<td ><a href=\"p_blokuj?id_u="+rs.getString(10)+"&id_user="+request.getParameter("id_user")+"\"><font color='blue'>zablokuj</font></a></td></tr>");  
      ...
      {
 out.println("<td><font color='green'>zablokowane</td>");
 out.print("<td ><a href=\"p_odblokuj?id_u="+rs.getString(10)+"&id_user="+request.getParameter("id_user")+"\"><font color='red'>odblokuj</font></a></td></tr>");  
      }  
