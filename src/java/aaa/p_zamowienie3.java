 ...
 * @author  
 */
@WebServlet(name="p_zamowienie3", urlPatterns={"/p_zamowienie3"})
public class p_zamowienie3 extends HttpServlet {
...
sql.executeUpdate("update koszyk set realizacja=('2') where id_user=('"+id_uu+"') and data_realizacji=('"+dd+"') and realizacja='1';");

response.sendRedirect("p1?id_user="+request.getParameter("id_user")+"");
