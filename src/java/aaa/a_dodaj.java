 ...
 * @author  
 */
@WebServlet(name="a_dodaj", urlPatterns={"/a_dodaj"})
public class a_dodaj extends HttpServlet {
...
"	<form class=\"form-horizontal\" method=\"post\" action=\"a_dodaj2\" >\n" +
...
"			<label class=\"col-md-3 form-control-label required\">Wybierz nazw&#281;  kategorii</label>\n" +
"			<div class=\"col-md-6\">\n" +
"			<select class=\"form-control\"  name='id_rodzaj' >");
               
               
               
               
               
                 ResultSet rs11 = sql11.executeQuery("Select nazwa,id_rodzaj from rodzaj order by nazwa;");
                   while(rs11.next())
...
"<br><br> <h3>Brak kategorii - Podaj nazw&#281; nowej kategorii</h3> <form  method=\"post\" action=\"a_dodaj_kategoria\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj nazw&#281; nowej kategorii</label><div class=\"col-md-6\"><input class=\"form-control\" name=\"kategoria\" value=\"\"></div>\n" +
