 ...
 * @author  
 */
@WebServlet(name="zmien_haslo", urlPatterns={"/zmien_haslo"})
public class zmien_haslo extends HttpServlet {
...
String haslo2=request.getParameter("haslo2");
      ...
      sql=polaczenie.createStatement();
               ...
               sql.executeUpdate("update user set  haslo=('"+haslo3+"') where id_user=('"+id_user+"');");
               polaczenie.close();

                response.sendRedirect("zmiana2.jsp?id_user="+request.getParameter("id_user")+"");
