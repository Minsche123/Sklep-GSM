...
String email= request.getParameter("email");
    ...
    HttpSession session=request.getSession();
      ...
      Connection polaczenie;
           ...
           Statement sql001;     Statement sql002;     Statement sql003;Statement sql0022;
      
      Statement sql;
      Statement sql2;
      Statement sql9;  Statement sql10;
        Statement sql3;
      ...
      polaczenie=DriverManager.getConnection("jdbc:mysql://"+nazwaserwera+"/"+nazwabazy+"?user="+nazwauzytkownika+"&password="+haslobazy);
        sql001=polaczenie.createStatement(); sql002=polaczenie.createStatement(); sql003=polaczenie.createStatement();
      
      sql=polaczenie.createStatement();sql0022=polaczenie.createStatement(); 
      sql2=polaczenie.createStatement();
      sql9=polaczenie.createStatement();
sql10=polaczenie.createStatement();
...
"");
 ...
 out.write("function przetwarzajj_dane (){\n");
      ...
      out.write("  var formularz = document.forms[1];\n");
      out.write("  var napis = \"\";\n");
      out.write("  \n");

         out.write("         var WzorTel = /^[0-9]{9}$/;\n");

 out.write("         var WzorKod = /^[0-9]{2}-[0-9]{3}$/;\n");
            
     
                
      out.write("    if (formularz.imie.value== \"Imie...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano imienia\\n\"\n");
      ...
      out.write(" \n");
            ...
            out.write("    if (formularz.nazwisko.value== \"Nazwisko...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano nazwiska\\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
      
      
            out.write("    if (formularz.haslo.value== \"Haslo...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano hasla\\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
      
           out.write("    if (formularz.ulica.value== \"Ulica...\")\n");
      out.write("  {\n");
      ...
      out.write(" \n");
               ...
               out.write("    if (formularz.miasto.value== \"Miasto...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano nazwy miasto \\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
                  ...
                  out.write("    if (formularz.numer.value== \"Nr ulicy...\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano nr ulicy\\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write(" \n");
      ...
      out.write("  {\n");
      out.write("    napis += \"Niepoprawny kod pocztowy (00-000) \\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write("\n");
      ...
      out.write("  {\n");
      out.write("    napis += \"Niepoprawny nr telefonu (9 cyfr) \\n\"\n");
      out.write("    brakuje_danych = true;\n");
      out.write("  }\n");
      out.write("\n");
...
"");
   ...
   while(rs002.next())  {
      ...
      out.write(" <li><a href=\"kategorie?id_kategorie="+rs002.getString(2)+"\">"+rs002.getString(1)+" </a></li>");
...
"                                 <form class=\"form-inline navbar-search\" method=\"post\" action=\"szukaj\" >\n" +
...
"	   <ul class=\"category-top-menu\">");
   ...
   while(rs0022.next())  {
      ...
      out.write(" <li><a href=\"kategorie?id_kategorie="+rs0022.getString(2)+"\">"+rs0022.getString(1)+" </a></li>");
...
"     <ul class=\"category-top-menu\">");
   ...
   while(rs003.next())  {
      ...
      out.write(" <li><a href=\"producent?id_producent="+rs003.getString(2)+"\">"+rs003.getString(1)+" </a></li>");
...
"<h1>Rejestracja konta w systemie</h1>\n" +
"        </header>\n" +
...
out.write("<form id=\"login-form\"  method=\"post\" action=\"rejestracja3\" onsubmit=\"return przetwarzajj_dane()\">");
out.write(" <section>");
...
out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Podaj has&#322;o </label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='password' name='haslo' value='Haslo...' onfocus=\"if(this.value=='Kod...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Haslo...'}\"></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");

    out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Podaj imi&#281;  </label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='imie' value='Imie...' onfocus=\"if(this.value=='Imie...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Imie...'}\" ></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
                   
   
     out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Podaj nazwisko  </label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='nazwisko' value='Nazwisko...' onfocus=\"if(this.value=='Nazwisko...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Nazwisko...'}\"></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
      ...
      out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Podaj miasto   </label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='miasto' value='Miasto...' onfocus=\"if(this.value=='Miasto...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Miasto...'}\"></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
   
 
       out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Nazwa ulicy   </label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='ulica'  value='Ulica...' onfocus=\"if(this.value=='Ulica...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Ulica...'}\"  ></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
       ...
       out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Nr lokalu/mieszkania</label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='numer' value='Nr ulicy...' onfocus=\"if(this.value=='Nr ulicy...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Nr ulicy...'}\" ></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
        ...
        out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Kod pocztowy</label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='kodpocztowy' value='Kod...' onfocus=\"if(this.value=='Kod...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Kod...'}\" ></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>");               
   
 
         out.write("<div class=\"form-group row \">");
 out.write("<label class=\"col-md-3 form-control-label required\">Numer telefonu</label>");
 out.write("<div class=\"col-md-6\"><input class=\"form-control\" type='text' name='telefon' value='Telefon...' onfocus=\"if(this.value=='Telefon...'){this.value=''}\" onblur=\"if(this.value==''){this.value='Telefon...'}\" ></div>");
 out.write("<div class=\"col-md-3 form-control-comment\"></div>");
 out.write("</div>"); 
 
 
  out.write("<input type='hidden' name='email' value='"+request.getParameter("email")+"'>");
...
"\n" +
"<br><button class=\"btn btn-primary\" data-link-action=\"sign-in\" type=\"submit\" class=\"form-control-submit\">Dalej</button>\n" +
"</div>\n" +
"</div>\n" +
"    </section></form>\n" +
"\n" +
