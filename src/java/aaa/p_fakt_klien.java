 ...
 * @author  
 */
@WebServlet(name="p_fakt_klien", urlPatterns={"/p_fakt_klien"})
public class p_fakt_klien extends HttpServlet {
...
"      \n" +
"\n" +
"  <form  method=\"post\" action=\"p_fakt_klien2\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj fraz&#281; wyszukwania</label>\n" +
"<div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"fraza3\" value=\"\"></div>\n" +
