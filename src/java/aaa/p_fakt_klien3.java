 ...
 * @author  
 */
@WebServlet(name="p_fakt_klien3", urlPatterns={"/p_fakt_klien3"})
public class p_fakt_klien3 extends HttpServlet {
...
String data_realizacji= request.getParameter("data_realizacji");
   ...
   String id_user= request.getParameter("id_user");
    ...
    HttpSession session=request.getSession();
      ...
      Connection polaczenie;
           ...
           Statement sql001;     Statement sql002;   Statement sql0022;  Statement sql003;Statement sql004; Statement sql005;Statement sql008; Statement sql009;
      ...
      Statement sql; Statement sql0150; Statement sql090;Statement sql11;
      Statement sql2;
      Statement sql9;  Statement sql10;Statement sql12;Statement sql15;
        Statement sql3;
...
sql10=polaczenie.createStatement();sql11=polaczenie.createStatement();sql12=polaczenie.createStatement();
         sql3=polaczenie.createStatement();   sql15=polaczenie.createStatement(); sql0022=polaczenie.createStatement();
...
"");
   ...
   while(rs002.next())  {
      ...
      out.write(" <li><a href=\"kategorie3?id_kategorie="+rs002.getString(2)+"\">"+rs002.getString(1)+" </a></li>");
...
"                                 <form class=\"form-inline navbar-search\" method=\"post\" action=\"szukaj3\" >\n" +
...
out.write("	<p><b>Witamy<strong> <font color=\"#990000\"> "+session.getAttribute("imie")+" "+session.getAttribute("nazwisko")+"</font> - pracownik sklepu</strong></b></p>");         
...
"     <ul class=\"category-top-menu\">");
                 ...
                 out.write("<li><a href=\"p1?id_user="+request.getParameter("id_user")+"\">Przegl&#261;d zam&#243;wie&#324;</a></li>" +
"<li ><a href=\"a_dodaj?id_user="+request.getParameter("id_user")+"\">Dodaj produkt</a></li>\n" +
"<li><a href=\"p_fakt_klien?id_user="+request.getParameter("id_user")+"\">Faktury klient&#243;w</a></li>\n" +
"<li ><a href=\"p_dane_klient?id_user="+request.getParameter("id_user")+"\">Dane u&#380;ytkownik&#243;w</a></li>\n" +
"<li ><a href=\"p_wyszukiwarka?id_user="+request.getParameter("id_user")+"\">Wyszukiwarka</a></li>\n" +
"<li ><a href=\"p_producenci?id_user="+request.getParameter("id_user")+"\">Producenci</a></li>\n" +
"<li ><a href=\"p_kategorie?id_user="+request.getParameter("id_user")+"\">Kategorie</a></li>\n" +
"<li ><a  href=\"p_zmina?id_user="+request.getParameter("id_user")+"\">Zmiana danych</a></li>\n" +
...
out.write(" <li><a href=\"kategorie3?id_kategorie="+rs0022.getString(2)+"&id_user="+request.getParameter("id_user")+"\">"+rs0022.getString(1)+" </a></li>");
...
while(rs003.next())
{
    out.write(" <li><a href=\"producent3?id_producent="+rs003.getString(2)+"&id_user="+request.getParameter("id_user")+"\">"+rs003.getString(1)+" </a></li>");
}
out.write(" </ul>\n" +
"</div>\n" +
"</div>\n" +
...
"        </header>");
      ...
      ResultSet rs9 = sql9.executeQuery("SELECT DISTINCT user.imie,user.nazwisko,user.miasto,user.ulica,user.nr_u,user.kod,user.telefon,user.email from user where user.id_user='"+id_u+"'  ");
  while(rs9.next())  {


            out.print("<h2>Klient:</strong> ");
                 out.print(""+rs9.getString(1)+" "+rs9.getString(2)+"</h2>");

        out.print("<h3>Dane adresowe:</strong> ");
        out.print(""+rs9.getString(3)+" <b>&nbsp;ul. &nbsp;</b>"+rs9.getString(4)+" <b>numer </b>"+rs9.getString(5)+"<b> &nbsp;kod&nbsp;</b> "+rs9.getString(6)+"</h3>");
          out.print("<h4><strong>Dane kontaktowe:&nbsp; ");
        out.print("<b>&nbsp;tel. </b>&nbsp;"+rs9.getString(7)+" &nbsp;<b>&nbsp;email: &nbsp;</b>"+rs9.getString(8)+" </h4>");
...
"              <tbody>");
      ...
      ResultSet rs15 = sql15.executeQuery("Select magazyn.nazwa, magazyn.cena, magazyn.id_magazyn,koszyk.id_koszyk,koszyk.ilosc,magazyn.obraz from magazyn,koszyk,opis_towaru where koszyk.id_user='"+id_u+"' and koszyk.data_realizacji='"+data_realizacji+"'   and koszyk.id_magazyn=magazyn.id_magazyn and magazyn.id_magazyn=opis_towaru.id_magazyn;");
int nr_wiersza=1;
float koniec=0;
      while(rs15.next())  {
     ...
     out.write("				<tr>\n" +
"                  <td> <img width=\"60\" src=\""+rs15.getString(6)+"\" alt=\"\"/></td>\n" +
"                  <td>"+rs15.getString(1)+"</td>\n" +
"				  <td>"+rs15.getString(5)+" \n" +

       
"				  </td>\n" +
"                  <td>"+rs15.getString(2)+" z&#322;</td>\n" +
...
"                ");
 ...
 out.println("<td><font color='red'>" + sumka );
 out.println(" z&#322; </font></td></tr>");
...
koniec += sumka;
         ...
         out.println(" <tr>");
            out.println("<td></td><td></td><td></td><td><strong>SUMA</strong></td>");
           out.println(" <td > <strong>" + koniec);

                 out.println(" z&#322;</strong></td></tr>");
