 ...
 * @author  
 */
@WebServlet(name="w_zmina3", urlPatterns={"/w_zmina3"})
public class w_zmina3 extends HttpServlet {
...
"<li ><a href=\"p_modele?id_user="+request.getParameter("id_user")+"\">Modele i marki</a></li>\n" +
...
"            <p><b>*** Proces zmiany has&#322;a zako&#324;czony powodzeniem ***</b></p>\n" +
"        </div>\n" +
"    \n" +
"\n" +
"    \n" +
