 ...
 * @author  
 */
@WebServlet(name="wyszukiwarka", urlPatterns={"/wyszukiwarka"})
public class wyszukiwarka extends HttpServlet {
...
"      \n" +
"\n" +
"  <form  method=\"post\" action=\"wyszukiwarka2\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
