...
"		<ul class=\"product_list grid gridcount\">");
  ...
  ResultSet rs9 = sql9.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis from magazyn,rodzaj,opis_towaru where (magazyn.nazwa like '%"+fraza+"%') and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj  and magazyn.id_magazyn=opis_towaru.id_magazyn;");
                   ...
                   ResultSet rs = sql.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis,opis_towaru.opis_skrocony from magazyn,rodzaj,opis_towaru where (magazyn.nazwa like '%"+fraza+"%') and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj and magazyn.id_magazyn=opis_towaru.id_magazyn;");
