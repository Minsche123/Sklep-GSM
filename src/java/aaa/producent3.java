...
@WebServlet(name="producent3", urlPatterns={"/producent3"})
public class producent3 extends HttpServlet {
...
String id_producent= request.getParameter("id_producent");
...
"<div id=\"content-wrapper\" class=\"left-column col-xs-12 col-sm-8 col-md-9 col-lg-9\">");
           ...
           out.write("<section id=\"main\">");
             ...
             ResultSet rs004 = sql004.executeQuery("select typ from typ where id_typ='"+id_producent+"';");

   while(rs004.next())  {
         
out.write("<h3 class=\"subcategory-heading\">Producent: <font color='red'>"+rs004.getString(1)+"</font></h3>");

                ResultSet rs005 = sql005.executeQuery("SELECT COUNT(*) FROM magazyn WHERE id_typ='"+id_producent+"';");
...
"		<ul class=\"product_list grid gridcount\">");
  ...
  ResultSet rs9 = sql9.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis from magazyn,rodzaj,opis_towaru where magazyn.id_typ='"+id_producent+"'  and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj  and magazyn.id_magazyn=opis_towaru.id_magazyn;");
                   ...
                   ResultSet rs = sql.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis,opis_towaru.opis_skrocony from magazyn,rodzaj,opis_towaru where magazyn.id_typ='"+id_producent+"' and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj and magazyn.id_magazyn=opis_towaru.id_magazyn;");
