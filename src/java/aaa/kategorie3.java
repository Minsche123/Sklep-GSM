...
@WebServlet(name="kategorie3", urlPatterns={"/kategorie3"})
public class kategorie3 extends HttpServlet {
...
String id_kategorie= request.getParameter("id_kategorie");
...
"<div id=\"content-wrapper\" class=\"left-column col-xs-12 col-sm-8 col-md-9 col-lg-9\">");
           ...
           out.write("<section id=\"main\">");
             ...
             ResultSet rs004 = sql004.executeQuery("select nazwa from rodzaj where id_rodzaj='"+id_kategorie+"';");

   while(rs004.next())  {
         
out.write("<h3 class=\"subcategory-heading\">Kategoria: <font color='red'>"+rs004.getString(1)+"</font></h3>");

                ResultSet rs005 = sql005.executeQuery("SELECT COUNT(*) FROM magazyn WHERE id_rodzaj='"+id_kategorie+"';");
...
"	</ul>\n" +
"	\n" +
"	      <p>Produktów w tej kategorii: <b>"+rs005.getString(1)+"</b></p>");
...
"		<ul class=\"product_list grid gridcount\">");
  ...
  ResultSet rs9 = sql9.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis from magazyn,rodzaj,opis_towaru where magazyn.id_rodzaj='"+id_kategorie+"'     and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj  and magazyn.id_magazyn=opis_towaru.id_magazyn;");
                   ...
                   ResultSet rs = sql.executeQuery("Select magazyn.cena,magazyn.nazwa,magazyn.obraz,magazyn.id_magazyn,magazyn.id_magazyn,rodzaj.nazwa,rodzaj.nazwa,opis_towaru.opis,opis_towaru.opis_skrocony from magazyn,rodzaj,opis_towaru where magazyn.id_rodzaj='"+id_kategorie+"' and magazyn.aktywny='1' and magazyn.id_rodzaj=rodzaj.id_rodzaj and magazyn.id_magazyn=opis_towaru.id_magazyn;");
...
"    \n" +
"      <a href=\"p_1_3?id_magazyn="+rs.getString(5)+"&id_user="+request.getParameter("id_user")+"\" class=\"thumbnail product-thumbnail\">\n" +
...
"            <a href=\"p_1_3?id_magazyn="+rs.getString(5)+"&&id_user="+request.getParameter("id_user")+"\" class=\"btn btn-primary view-button\" title=\"View Detail\">                Zobacz więcej</a>\n" +
"           \n" +
"        </div>                                \n" +
"\n" +
"    </div>\n" +
...
"<a href=\"p_1_3?id_magazyn="+rs.getString(5)+"&&id_user="+request.getParameter("id_user")+"\" title=\"consectetur adipiscing\" title=\"consectetur adipiscing\">"+rs.getString(2)+"</a></h3>\n" +
