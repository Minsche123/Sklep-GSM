 ...
 * @author  
 */
@WebServlet(name="p_wyszukiwarka", urlPatterns={"/p_wyszukiwarka"})
public class p_wyszukiwarka extends HttpServlet {
...
"      \n" +
"\n" +
"  <form  method=\"post\" action=\"p_wyszukiwarka2\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj fraz&#281; wyszukiwania</label>\n" +
"<div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"fraza2\" value=\"\"></div>\n" +
...
"			<label class=\"col-md-3 form-control-label required\">Szukaj wed&#322;ug</label>\n" +
"			<div class=\"col-md-6\">\n" +
...
out.write("<option value=\"magazyn.nazwa\">nazwie");
out.write("<option value=\"opis_towaru.opis\">opis towaru");
out.write("<option value=\"magazyn.cena\">cena ");
