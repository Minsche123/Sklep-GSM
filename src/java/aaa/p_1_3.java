...
@WebServlet(name="p_1_3", urlPatterns={"/p_1_3"})
public class p_1_3 extends HttpServlet {
...
"  </section>\n" +
        ...
        "	<div><div>			<form  method=\"post\" action=\"a_skasuj\">\n" +
...
"					  <button type=\"submit\" class=\"btn btn-large btn-primary pull-right\"> Skasuj </button>\n" +


"				</form>\n" +
                    
                    
       "				<form   method=\"post\" action=\"a_edytuj_2\">\n" +
                    ...
                    "<input  type='hidden' name='id_magazyn' value='"+rs10.getString(5)+"'>\n" +
            "<input  type='hidden' name='id_user' value='"+request.getParameter("id_user")+"'>\n" +
"					  <button type=\"submit\" class=\"btn btn-large btn-primary pull-right\"> Edytuj </button>\n" +
