 ...
 * @author  
 */
@WebServlet(name="p_producenci", urlPatterns={"/p_producenci"})
public class p_producenci extends HttpServlet {
...
"");
 ...
 out.write("function przetwarzajj_dane (){\n");
      ...
      out.write("    if (formularz.producent.value== \"\")\n");
      out.write("  {\n");
      out.write("    napis += \"Nie podano nazwy producenta\\n\"\n");
...
"<h1>Zarz&#261;dzaj nazwami producentów</h1>\n" +
"        </header>\n" +
"      \n" +
"    \n" +
"\n" +
...
"	<hr class=\"soft\"/>");
   ...
   ResultSet rs9 = sql9.executeQuery("SELECT typ,id_typ from typ order by typ;");
...
"              <tbody>");
 ...
 ResultSet rs = sql.executeQuery("SELECT typ,id_typ from typ order by typ;");
...
int nr_wiersza=1;
      ...
      while(rs.next())  {
           ...
           out.print("<tr class=\"row-a\"><td class=\"first\">"+ nr_wiersza + ".</td><td>"+rs.getString(1)+"</td>");
         out.print("</tr>");
        nr_wiersza++;
      }
...
out.write(" <br><h3> Dodaj producenta</h3><form  method=\"post\" action=\"dodaj_producent\" onsubmit=\"return przetwarzajj_dane()\">\n" +
"\n" +
"    <section>\n" +
"      \n" +
"                  \n" +
"<div class=\"form-group row \">\n" +
"<label class=\"col-md-3 form-control-label required\">Podaj nazw&#281; producenta</label>\n" +
"<div class=\"col-md-6\"><input class=\"form-control\" type='text' name=\"producent\" value=\"\"></div>\n" +
