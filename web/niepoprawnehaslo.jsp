...
<h1>Zaloguj się do swojego konta</h1>
  ...
  <form id="login-form"  method="post" action="logowanie" onsubmit="return przetwarzajj_dane()">
  	<div class="alert alert-block alert-error fade in">   
            <p><b>*** Podane hasło dla adresu email <font color="#990000"><%= session.getAttribute("email") %></font> nie jest poprawne ***</b></p>
        </div>
            <section>
...
<div class="col-md-6"><input class="form-control" name="email" type="text"value=""></div>
...
<input class="form-control" type="password"  name="haslo"></div>
