...
<h1>Rejestracja konta w systemie</h1>
  ...
  <form id="login-form"  method="post" action="rejestracja" onsubmit="return przetwarzajj_dane()">

    <section>
      
      	<div class="alert alert-block alert-error fade in">   
            <p><b>*** Podane adres email wykorzystano do założenia konta w systemie ***</b></p>
        </div>              
<div class="form-group row ">
<label class="col-md-3 form-control-label required">Podaj adres Email</label>
