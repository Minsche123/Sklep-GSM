...
ResultSet rs2 = stmt2.executeQuery(retrieveString2);
  ...
  <li class="category"><a href="kategorie2?id_kategorie=<%= rs2.getString(2)%>&id_user=<%= session.getAttribute("id_user") %>" class="dropdown-item" data-depth="0"><%= rs2.getString(1)%> </a></li>
	  ...
	  <section id="wrapper">
          ...
          <div id="columns_inner">
            ...
            <div id="left-column" class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
                ...
                <p><b>Witamy<strong>  <font color="#990000"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - KLIENT</strong></b></p>
...
<div class="sidebar-featured block">
 ...
 <div class="block_content collapse" id="block_featured_toggle"> 
  ...
  <li ><a  href="koszyk?id_user=<%= session.getAttribute("id_user") %>">Koszyk</a></li>
<li  ><a href="zamowienie?id_user=<%= session.getAttribute("id_user") %>">Status zamówień</a></li>
<li ><a  href="wyszukiwarka?id_user=<%= session.getAttribute("id_user") %>">Wyszukiwarka</a></li>
<li c><a  href="zmiana.jsp?id_user=<%= session.getAttribute("id_user") %>">Zmiana hasla</a></li>
...
ResultSet rs2 = stmt2.executeQuery(retrieveString2);
  ...
  <li ><a href="kategorie2?id_kategorie=<%= rs2.getString(2)%>&id_user=<%= session.getAttribute("id_user") %>" ><%= rs2.getString(1)%> </a></li>
...
ResultSet rs2 = stmt2.executeQuery(retrieveString2);
    while(rs2.next()) {
    %>
      <li><a href="producent2?id_producent=<%= rs2.getString(2)%>&id_user=<%= session.getAttribute("id_user") %>"><%= rs2.getString(1)%> </a></li>
